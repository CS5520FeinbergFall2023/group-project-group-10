...
public class CreatePostDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        postButton.setOnClickListener(v -> {
            ...
            post.put("uid", currUser.getUid());
            dbRef.child("users").child(currUser.getUid()).child("username").get().addOnCompleteListener(task -> {
        ...
        cancelButton.setOnClickListener(v -> CreatePostDialog.this.getDialog().cancel());
    ...
    private void uploadPost(String postId) {
        if (hasImage) {
            ...
            uploadTask.addOnSuccessListener(taskSnapshot -> taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(uri -> {
                ...
                dbRef.child("posts").child(postId).setValue(post).addOnSuccessListener(unused -> CreatePostDialog.this.getDialog().cancel());
            }));
